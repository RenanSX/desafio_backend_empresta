...
{
    /**
     *  Método que retorna todas as instituições
     *
    ...
    public function index() {
        try {
            $response = [];
            // Pega o arquivo .json de instituições e transforma em array
            $json = Storage::disk('local')->get('database/instituicoes.json');
